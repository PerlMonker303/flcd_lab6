...
public:
	...
	static bool findInSet(std::unordered_set<std::string> set, std::string elem);
	static void removeElementFromSet(std::unordered_set<std::string>& set, std::string elem);
	...
	static std::unordered_set<std::string> union_custom(std::unordered_set<std::string> set1, std::unordered_set<std::string> set2, bool noEpsilon = false);
